...
"	vec3 lightDirection = light_location-position_tmp; \n"
//"	vec3 lightDirection = camera_orientation[2]; \n"
...
"	FragColor = vec4(vColor*color*(1-shadow/2), 1.0); \n"
//"	FragColor = vec4(color*(1-vColor*shadow/2), 1.0); \n"
//"	FragColor = vec4(vColor*color, 1.0); \n"
//"	FragColor = vec4(vColor*vec3(texCoord, 1.0), 1.0); \n"
